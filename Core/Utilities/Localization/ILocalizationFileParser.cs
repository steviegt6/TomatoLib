...
{
    /// <summary>
    ///     Provides a way to implement file parsing for localization files.
    /// </summary>
    public interface ILocalizationFileParser
    {
        ...
        /// </summary>
        IDictionary<string, ModTranslation> ParseNonModFile(Mod mod, string culture, string filePath,
        ...
        /// </summary>
        IDictionary<string, ModTranslation> ParseModFile(Mod mod, string culture, string modFilePath,
            Dictionary<string, ModTranslation> translations)
        {
